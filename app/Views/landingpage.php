...
<head>
    ...
    <title>Aiotech ITPLN</title>
    <link rel="icon" type="image/x-icon" href="/assets/img/logos/aiotech.png" style="width: 20px;" />
...
<body id="page-top">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav">
        <div class="container">
            <a class="navbar-brand js-scroll-trigger" href="#page-top"><img src="/assets/img/logos/aiotech_brand_white.png" alt="" /></a>
                ...
                <li>
                    ...
                    <div class="timeline-panel">
                        <div class="timeline-heading">
                            <h4>2020</h4>
                            <h4 class="subheading">Our Beginnigs</h4>
                        </div>
                        <div class="timeline-body">
                            <p class="text-muted">AIoTech is a startup company engaged in software development and research in the fields of Artificial Intelligence, Internet of Things and Technology.</p>
                        </div>
                    </div>
                </li>
    ...
    <section class="page-section bg-light" id="team">
        <div class="container">
            ...
            <div class="row">
                <div class="col">
                    <div class="team-member">
                        <img class="mx-auto rounded-circle" src="assets/img/team/default.jpg" alt="COM" />
                        <h4>Haris Manjakawang</h4>
                        <p class="text-muted">Co-Founder and Commissioner</p>
                    </div>
                </div>
                <div class="col">
                    <div class="team-member">
            ...
            <div class="row">
                ...
                <div class="col-lg-3">
                    <div class="team-member">
                        <img class="mx-auto rounded-circle profile" src="assets/img/team/pepi.JPG" alt="CFO" />
                        <h4>Pepi Nigatama</h4>
                        <p class="text-muted">Chief Content Officer</p>
                    </div>
                </div>
                <div class="row">
                    <div class="col-lg-8 mx-auto text-center">
                        <p class="large text-muted">Humans are creatures with extraordinary intellectual intelligence, such as current AI technology which has penetrated into various fields making it easier to apply human thought or intelligence to a computer or system..</p>
                    </div>
                </div>
            </div>
        </div>
